...
assert.match(home, /styles\.css\?v=2\.1\.4/, 'homepage requests the repaired stylesheet revision');
...
assert.match(sw, /allthings140-radio-v70/, 'service worker activates a new cache generation');
