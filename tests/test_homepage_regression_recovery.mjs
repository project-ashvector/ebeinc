...
assert.match(home, /allthings140-background\.mp4\?v=2\.1\.0/, 'homepage references the lightweight canonical desktop background');
assert.match(home, /allthings140-background-mobile\.mp4\?v=2\.1\.0/, 'homepage references the lightweight canonical mobile background');
...
assert.match(sw, /allthings140-radio-v66/, 'service worker activates a new cache generation');
