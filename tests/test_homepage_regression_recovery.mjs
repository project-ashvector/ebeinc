...
assert.match(home, /main-vis-home-v1\.mp4\?v=1\.0\.0/, 'homepage references the web derivative of the user-selected master');
...
assert.match(sw, /allthings140-radio-v67/, 'service worker activates a new cache generation');
