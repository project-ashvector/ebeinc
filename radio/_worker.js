...
const PUBLIC_POST_PATH = /^\/api\/public\/(?:support\/(?:checkout|webhook)|requests|submissions|newsletter|takeover-interest|takeover-application|takeover-invite\/[A-Za-z0-9_-]+)$/;
